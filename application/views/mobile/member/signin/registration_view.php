...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/mobile/member/signin/style.registration.css'); ?>">
<script type="text/javascript" src="<?php echo base_url('assets/js/member/signin/jquery.registration.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/mobile/member/signin/jquery.registration.js'); ?>"></script>
...
<form id="form-regist" action="<?php echo base_url('member/request'); ?>" method='post' data-ajax="false">
	<div class="signin-header">

		<div class="top">
			<img class="state-image" src="<?php echo base_url('assets/images/mobile/member/signin/step_02.png'); ?>" style="width: 100%;"/>
		</div>

		<div class="bottom">
			<div class="desc">
				<p><font class="highlight-color">회원가입</font>을 환영합니다.</p>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a href="javascript:isExists()"><span class="round-button" name="idcheck">중복 확인</span></a>
					<div>회원 ID는 가입 후 변경이 불가능합니다.</div>
			...
			<tr>
				...
				<td>
					...
					<div> 4~12자의 영문,숫자,특문을 조합하셔서 공백없이 기입해주세요.</div>
				</td>
			</tr>
			<tr>
				<th>비밀번호 확인</th>
...
<!-- 				<th>주소</th>
				<td>
					...
					<br />
					<input type="text" name="member_addr" readonly="readonly" placeholder="주소" />
					<input type="text" name="member_addr_detail" placeholder="상세주소" />
				</td>
			-->
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<div data-role="fieldcontain">
						<input type="text" name="member_mail_account">
						<span>@</span>
						<input type="text" name="member_mail_domain">
					...
					<label for="agree_recvmail">이메일 수신에 동의합니다.<input type="checkbox" name="member_recvmail" id="agree_recvmail" checked="checked"></label>
				</td>
			</tr>
			<tr>
				<th>전화번호</th>
				<td>
					<select name="tel_id" data-inline="true" data-icon="false">
					...
					<span>-</span>
					<input type="number" name="tel_01" style="width: 50px;" maxlength="4">
					<span>-</span>
					<input type="number" name="tel_02" style="width: 50px;" maxlength="4">
				</td>
			</tr>
			<tr>
				<th>휴대폰</th>
				<td>
					<select name="hp_id" data-inline="true" data-icon="false">
					...
					<span>-</span>
					<input type="number" name="hp_01" style="width: 50px;" maxlength="4" data-role="none">
					<span>-</span>
					<input type="number" name="hp_02" style="width: 50px;" maxlength="4" data-role="none">
				</td>
			</tr>
		</tbody>
	</table>
	<div class="button-box content-group" style="text-align: center;">
		<input type="submit" class="default-button" name="btnok" value="확인" data-inline="true" data-role="none"></input>
